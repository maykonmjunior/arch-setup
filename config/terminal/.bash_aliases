...
alias upd='sudo pacman -Suy --noconfirm && yay -Suy --noconfirm && sudo pacman -Qdtq | sudo pacman -Rns -'
...
alias set_ssh='eval "$(ssh-agent -s)" && ssh-add ~/.ssh/main/id_ed25519 && ssh-add ~/.ssh/ufsc/id_ed25519'
